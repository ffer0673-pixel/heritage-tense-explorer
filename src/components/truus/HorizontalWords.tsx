...
import '../../styles/truus/horizontal-words.css';
...
const HorizontalWords = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            arrows.forEach((arrowPath) => {
                const path = arrowPath as SVGPathElement;
    ...
    return (
        <section ref={sectionRef} className="horizontal-words-section content-section">
            <div ref={pinRef} style={{ width: '100%', height: '100%', position: 'relative' }}>
                ...
                <div className="horizontal-words__sticker-svg">
                    ...
                    <h2 className="display horizontal-words__h2" aria-label="Learn English Through Tangerang Local Wisdom">
                        {"Learn English Through Tangerang Local Wisdom".split("").map((char, index) => {
                            if (char === " ") {
                                return " ";
                            }
                            return (
