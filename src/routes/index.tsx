...
const TENSE_HERO_DATA: TenseHeroData[] = CATEGORIES.map((c) => ({
  ...
  tagline: `${TENSES.filter((t) => t.category === c.key).length} sub-tenses lengkap dengan rumus, contoh kalimat, dan latihan interaktif.`,
  byline: `${TENSES.filter((t) => t.category === c.key).length} sub-tenses`,
...
function Home() {
  ...
  return (
    <div>
      ...
      <section className="relative py-20 overflow-hidden bg-white light-scope">
        <div className="mx-auto max-w-7xl px-6">
